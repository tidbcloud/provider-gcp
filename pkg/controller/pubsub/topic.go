...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	topic.LateInitialize(&cr.Spec.ForProvider, *t) // nolint:govet
	...
	return managed.ExternalObservation{
		ResourceExists:   true,
		ResourceUpToDate: topic.IsUpToDate(cr.Spec.ForProvider, *t), // nolint:govet
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	...
	_, err = e.ps.UpdateTopic(ctx, topic.GenerateUpdateRequest(e.projectID, meta.GetExternalName(cr), cr.Spec.ForProvider, *t)) // nolint:govet
